...
const LandingPage = () => {
   ...
   return (
      <div className="min-h-screen flex flex-col items-center justify-start text-white p-6 relative"
           style={{ background: `linear-gradient(${gradientPosition}deg, rgba(var(--bg), 0.8) 0%, rgba(var(--bg), 1) 100%), rgb(var(--bg))`}}>
         <div></div>

         <main className='flex flex-col items-center justify-center grow text-center z-10 -mt-20'>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
               <button className="bg-secondary text-text font-bold py-2 px-8 rounded-full shadow-lg transition duration-300 transform hover:scale-105">
                  Comece sua jornada
               </button>
               <button className="border-2 border-secondary text-white font-bold py-2 px-8 rounded-full hover:text-secondary transition duration-300 transform hover:scale-105">
                  Para empresas
               </button>
            </div>
         </main>
